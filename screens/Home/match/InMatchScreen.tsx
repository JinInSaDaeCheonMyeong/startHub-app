        ...
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.headerContainer}>
                ...
                <View style={styles.headerContent}>
                    <Text style={styles.headerTitle}>{matchData?.jobType ?? "없음"}</Text>
            ...
            <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
                <View style={styles.companySection}>
                    <View style={styles.companyRow}>
                        <Text style={styles.companyName}>{matchData?.companyName ?? "없음"}</Text>
                        <Text style={styles.companyDate}>
                            {matchData?.updatedAt ? formatToDate(matchData.updatedAt) : "없음"}
                        </Text>
                    </View>
                    <Text style={styles.recruitTitle}>
                        [{matchData?.workType ?? "없음"}] {matchData?.title ?? "없음"}
                    </Text>
                </View>
                ...
                <View style={styles.textBox}>
                    ...
                    >
                        모집 : {matchData?.startDate ? formatToDate(matchData.startDate) : "없음"} ~{" "}
                        {matchData?.endDate ? formatToDate(matchData.endDate) : "없음"}
                    </Text>
                </View>
                ...
                <View style={styles.textBox}>
                    ...
                    <Text style={styles.boxContent}>
                        {matchData?.techStack?.length ? matchData.techStack.join(", ") : "없음"}
                    </Text>
                </View>
                ...
                <View style={styles.textBox}>
                    ...
                    <Text style={styles.boxContent}>
                        {matchData?.requiredPeople != null ? `${matchData.requiredPeople}명` : "없음"}
                    </Text>
                </View>

                <View style={styles.textBox}>
                    <Text style={styles.boxTitle}>세부 내용</Text>
                    <Text style={styles.boxContent}>{matchData?.content ?? "없음"}</Text>
                </View>

                <View style={styles.textBox}>
                    <Text style={styles.boxTitle}>우대사항</Text>
                    <Text style={styles.boxContent}>{matchData?.desiredCareer ?? "없음"}</Text>
                </View>
            </ScrollView>
